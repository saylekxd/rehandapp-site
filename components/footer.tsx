...
export default function Footer() {
  ...
  // Get current locale for building the correct links
  const currentLocale = i18n.language || 'en';

  return (
    <footer className="bg-card text-card-foreground py-8 md:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 md:space-y-0 md:grid md:grid-cols-4 md:gap-8">
          ...
          {/* Condensed links section for mobile - only essential links */}
        ...
        {/* Developer attribution - moved before separator for better mobile flow */}
        <div className="flex items-center justify-center md:justify-start gap-2 mt-6 md:mt-8 text-gray-400 text-xs md:text-sm">
        ...
        <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row md:justify-between md:items-center">
          ...
          {/* Social links - smaller and centered on mobile */}
