...
export function Features() {
    ...
    return (
        <section id="savings" className="bg-background py-16 md:py-32">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                <div className="flex justify-center">
            <div className="border py-1 px-4 rounded-lg">{t('features8.badge')}</div>
          </div>
                    <motion.h2 
                    ...
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <h2 className="mt-6 text-center text-3xl font-semibold">{t('features8.customizable.title')}</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto mt-6 flex aspect-square size-16 w-16 h-16 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                    <svg className="m-auto h-full w-full" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <div className="relative z-10 mt-16 space-y-2 text-center">
                                    <h2 className="group-hover:text-secondary-950 text-lg font-medium transition dark:text-white">{t('features8.secure.title')}</h2>
                                    <p className="text-foreground">{t('features8.secure.description')}</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <svg className="dark:text-muted-foreground w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g clipPath="url(#clip0_0_106)">
                                            ...
                                            <text x="90" y="35" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="16" fontWeight="500" fill="currentColor">
                                            Progres
                                            </text>
                                            <text x="290" y="35" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="16" fontWeight="500" fill="currentColor">
                                            34 min
                                            </text>
                                        </g>
                                        <path
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition">{t('features8.fast.title')}</h2>
                                    <p className="text-foreground">{t('features8.fast.description')}</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 w-12 h-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <Shield className="m-auto size-5 w-5 h-5" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition dark:text-white">{t('features8.analytics.title')}</h2>
                                        <p className="text-foreground">{t('features8.analytics.description')}</p>
                                    </div>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 w-12 h-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <Users className="m-auto size-6 w-6 h-6" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition">{t('features8.safety.title')}</h2>
                                        <p className="text-foreground">{t('features8.safety.description')}</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">{t('features8.employees.adam')}</span>
                                            <div className="ring-background size-7 w-7 h-7 ring-4">
                                                <img className="size-full rounded-full" src="/images/person-section/haircut-person.webp" alt="" />
                                            </div>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">{t('features8.employees.monika')}</span>
                                            <div className="ring-background size-7 w-7 h-7 ring-4">
                                                <img className="size-full rounded-full" src="/images/person-section/beauty-person.webp" alt="" />
                                            </div>
                                        </div>
                                        
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 w-8 h-8 ring-4">
                                                <img className="size-full rounded-full" src="/images/person-section/restaurant-person.webp" alt="" />
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">{t('features8.employees.kasia')}</span>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 w-8 h-8 ring-4">
                                                <img className="size-full rounded-full" src="/images/person-section/manager-person.webp" alt="" />
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">{t('features8.employees.krzys')}</span>
                                        </div>
